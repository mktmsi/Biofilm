...
for BossSet=SSSS:-1:1
    ...
    for ParameterSet=Sets:-1:0
        ThrePeak=1.0;
        PeakPro= 3.0;%interval100 のと�? 3.0   後半 25.0 paraset=20-8の�?:10.0 3-8の�?:5.0
        ...
        q=fix(tempParaSet/NumOfRetsuInSubPlot);%q:�?  r:余り
